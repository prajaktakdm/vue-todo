                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex">
                            ...
                            <button @click="submitTask" class="btn btn-primary rounded-0 ">Submit</button>
                        </div>
                        <!-- Task Table -->
                        ...
                        <table class="table table-bordered mt-2">
                            ...
                            <tbody>
                                ...
                                <td>
                                    <span @click="changeStatus(index)" class="pointer" :class="{'finished':task.status==='finished'}">{{task.name}}</span>
                                </td>
